  ...
  treatmentStyles: [
    {
      title: "対面施術",
      body:
        "新中野と銀座の事務所で梁蔭全先生が直接外気を発し、身体の不調にアプローチします。施術中、身体が温かくなる、痛みが和らぐなどの「超実感」を得られるのが特長です。",
      href: "/treatments/in-person"
    },
    {
      title: "遠隔気功療法",
      body:
        "時間と場所を問わず、梁蔭全先生が思念を通じて気を送ります。ニューヨーク在住の方の検査数値が正常範囲に戻った事例をはじめ、国内外で多数の実績があります。",
      href: "/treatments/remote"
    },
    {
      title: "個別指導",
      body:
        "梁蔭全先生による希望者個人に対する気功施術、梁気功指導、健康計画作成を行います。",
      href: "/treatments/private-instruction"
    },
    {
      title: "特別遠隔施術",
      body:
        "お正月や端午の節句、重陽の節句など、体調を崩しやすい季節の変わり目を中心に、決まった日時に希望者の皆さんに梁蔭全先生が一斉遠隔施術を実施します。",
