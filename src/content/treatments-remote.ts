...
const page: PageData = {
  ...
  sections: [
    ...
    },
    {
      title: "遠隔気功療法の科学大実験",
      bullets: [
        "日本医科大学教授品川嘉也先生主宰の科学実験中、梁蔭全先生は念力気功により遠隔外気を発し５分以内に金魚鉢にいた金魚８匹を眠らせました。この模様は、１９９２年版「文芸春秋」に掲載されました。",
        "科学実験中に梁蔭全先生は念力気功により、東京から北京へ向けて外気を発し何度も北京の実験水の成分を変えました。人体の７０％以上は水でできているので、梁蔭全先生の念力気功法の科学性と物質的作用が証明されました。（実験主宰者：電気通信大学名誉教授佐々木茂美先生）"
      ]
    },
    {
      title: "申し込み方法",
